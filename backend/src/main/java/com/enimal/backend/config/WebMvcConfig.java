...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    public List loginInessential = Arrays.asList("/user/login","/user/profile/**","/user/completion/**","/todayAnimal","/noticeList/**","/boardList/**","/user/profile/**","/user/completion/**"); //제외할 URL 패턴
    @Bean
